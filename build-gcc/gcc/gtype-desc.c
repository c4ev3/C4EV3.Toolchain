    ...
    {
      {
        ...
        gt_ggc_m_6answer ((*x).next);
        {
          size_t i0;
          for (i0 = 0; i0 != l0; i0++) {
            switch ((int) (cpp_token_val_index (&((*x).first[i0]))))
              {
              case CPP_TOKEN_FLD_NODE:
                {
                  union tree_node * const x1 =
                ...
                {
                  union tree_node * const x2 =
                    ((*x).first[i0].val.node.spelling) ? HT_IDENT_TO_GCC_IDENT (HT_NODE (((*x).first[i0].val.node.spelling))) : NULL;
                  gt_ggc_m_9tree_node (x2);
                }
                break;
              case CPP_TOKEN_FLD_SOURCE:
              ...
              case CPP_TOKEN_FLD_ARG_NO:
                {
                  union tree_node * const x3 =
                    ((*x).first[i0].val.macro_arg.spelling) ? HT_IDENT_TO_GCC_IDENT (HT_NODE (((*x).first[i0].val.macro_arg.spelling))) : NULL;
                  gt_ggc_m_9tree_node (x3);
                }
                break;
              case CPP_TOKEN_FLD_TOKEN_NO:
        ...
        case SYMTAB_FUNCTION:
          {
            ...
            gt_ggc_m_11symtab_node ((*sub).instrumented_version);
            gt_ggc_m_9tree_node ((*sub).orig_decl);
...
gt_ggc_mx_value_range (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_9tree_node ((*x).min);
      gt_ggc_m_9tree_node ((*x).max);
      gt_ggc_m_11bitmap_head ((*x).equiv);
    }
}
...
void
gt_ggc_mx_vec_ipcp_transformation_summary_va_gc_ (void *x_p)
{
  vec<ipcp_transformation_summary,va_gc> * const x = (vec<ipcp_transformation_summary,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct ipcp_transformation_summary& x_r ATTRIBUTE_UNUSED)
{
  struct ipcp_transformation_summary * ATTRIBUTE_UNUSED x = &x_r;
...
void
gt_ggc_mx_function_summary_ipa_fn_summary__ (void *x_p)
{
  function_summary<ipa_fn_summary*> * const x = (function_summary<ipa_fn_summary*> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
        ...
        case SYMTAB_FUNCTION:
          {
            ...
            gt_pch_n_11symtab_node ((*sub).instrumented_version);
            gt_pch_n_9tree_node ((*sub).orig_decl);
...
gt_pch_nx_value_range (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_11value_range))
    {
      gt_pch_n_9tree_node ((*x).min);
      gt_pch_n_9tree_node ((*x).max);
      gt_pch_n_11bitmap_head ((*x).equiv);
    }
}
...
void
gt_pch_nx_vec_ipcp_transformation_summary_va_gc_ (void *x_p)
{
  vec<ipcp_transformation_summary,va_gc> * const x = (vec<ipcp_transformation_summary,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_38vec_ipcp_transformation_summary_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct ipcp_transformation_summary& x_r ATTRIBUTE_UNUSED)
{
  struct ipcp_transformation_summary * ATTRIBUTE_UNUSED x = &x_r;
...
void
gt_pch_nx_function_summary_ipa_fn_summary__ (void *x_p)
{
  function_summary<ipa_fn_summary*> * const x = (function_summary<ipa_fn_summary*> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_33function_summary_ipa_fn_summary__))
    {
      gt_pch_nx (x);
    }
}
        ...
        switch ((int) (cpp_token_val_index (&((*x).first[i0]))))
          ...
          case CPP_TOKEN_FLD_NODE:
            ...
            }
            {
              ...
              if ((void *)(x) == this_obj)
                op (&(x2), cookie);
              (*x).first[i0].val.node.spelling = (x2) ? CPP_HASHNODE (GCC_IDENT_TO_HT_IDENT ((x2))) : NULL;
            }
            break;
          case CPP_TOKEN_FLD_SOURCE:
            if ((void *)(x) == this_obj)
          ...
          case CPP_TOKEN_FLD_ARG_NO:
            {
              ...
              if ((void *)(x) == this_obj)
                op (&(x3), cookie);
              (*x).first[i0].val.macro_arg.spelling = (x3) ? CPP_HASHNODE (GCC_IDENT_TO_HT_IDENT ((x3))) : NULL;
            }
            break;
          case CPP_TOKEN_FLD_TOKEN_NO:
            break;
    ...
    case SYMTAB_FUNCTION:
      {
        ...
        if ((void *)(x) == this_obj)
          op (&((*sub).instrumented_version), cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).orig_decl), cookie);
        if ((void *)(x) == this_obj)
...
void
gt_pch_p_38vec_ipcp_transformation_summary_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<ipcp_transformation_summary,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<ipcp_transformation_summary,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct ipcp_transformation_summary* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
...
void
gt_pch_p_33function_summary_ipa_fn_summary__ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct function_summary<ipa_fn_summary*> * x ATTRIBUTE_UNUSED = (struct function_summary<ipa_fn_summary*> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_desc_c[] = {
  ...
  },
  {
    ...
    &gt_ggc_mx_function_summary_ipa_fn_summary__,
    &gt_pch_nx_function_summary_ipa_fn_summary__
  },
  {
    &ipcp_transformations,
    1,
    sizeof (ipcp_transformations),
    &gt_ggc_mx_vec_ipcp_transformation_summary_va_gc_,
    &gt_pch_nx_vec_ipcp_transformation_summary_va_gc_
  },
  {
    &ipa_edge_args_sum,
    1,
