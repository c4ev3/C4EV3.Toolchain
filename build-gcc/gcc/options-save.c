...
{
  fputs ("\n", file);
  if (ptr1->x_align_functions != ptr2->x_align_functions)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "align_functions",
             ptr1->x_align_functions,
             ptr2->x_align_functions);

  if (ptr1->x_align_jumps != ptr2->x_align_jumps)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "align_jumps",
             ptr1->x_align_jumps,
  ...
  if (ptr1->x_align_labels != ptr2->x_align_labels)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "align_labels",
             ptr1->x_align_labels,
  ...
  if (ptr1->x_align_loops != ptr2->x_align_loops)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "align_loops",
             ptr1->x_align_loops,
...
{
  inchash::hash hstate;
  hstate.add_hwi (ptr->x_align_functions);
  hstate.add_hwi (ptr->x_align_jumps);
  hstate.add_hwi (ptr->x_align_labels);
  hstate.add_hwi (ptr->x_align_loops);
  ...
  hstate.add_hwi (ptr->x_flag_var_tracking);
...
void
cl_optimization_stream_out (struct bitpack_d *bp,
                            struct cl_optimization *ptr)
{
  ...
  bp_pack_value (bp, ptr->x_align_functions, 64);
  bp_pack_value (bp, ptr->x_align_jumps, 64);
  bp_pack_value (bp, ptr->x_align_labels, 64);
  bp_pack_value (bp, ptr->x_align_loops, 64);
...
void
cl_optimization_stream_in (struct bitpack_d *bp,
                           struct cl_optimization *ptr)
{
  ...
  ptr->x_align_functions = (int ) bp_unpack_value (bp, 64);
  ptr->x_align_jumps = (int ) bp_unpack_value (bp, 64);
  ptr->x_align_labels = (int ) bp_unpack_value (bp, 64);
  ptr->x_align_loops = (int ) bp_unpack_value (bp, 64);
