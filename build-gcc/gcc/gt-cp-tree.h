      ...
      switch ((int) (((*x).u).base.selector))
        ...
        case lds_decomp:
          ...
          switch ((int) ((*x).u.base.u2sel))
            {
            case 0:
              gt_ggc_m_9tree_node ((*x).u.decomp.min.u2.access);
              break;
            case 1:
              break;
            default:
      ...
      switch ((int) (((*x).u).base.selector))
        ...
        case lds_decomp:
          ...
          switch ((int) ((*x).u.base.u2sel))
            {
            case 0:
              gt_pch_n_9tree_node ((*x).u.decomp.min.u2.access);
              break;
            case 1:
              break;
            default:
  ...
  switch ((int) (((*x).u).base.selector))
    ...
    case lds_decomp:
      ...
      switch ((int) ((*x).u.base.u2sel))
        ...
        case 0:
          if ((void *)(x) == this_obj)
            op (&((*x).u.decomp.min.u2.access), cookie);
          break;
        case 1:
          break;
        default:
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_rd_gt_cp_tree_h[] = {
  { &ovl_cache, 1, sizeof (ovl_cache), NULL, NULL },
  LAST_GGC_ROOT_TAB
};
