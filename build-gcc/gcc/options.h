...
enum opt_code
{
  ...
  OPT_mlittle_endian = 1216,                 /* -mlittle-endian */
  OPT_mlong_calls = 1217,                    /* -mlong-calls */
  ...
  OPT_muclibc = 1238,                        /* -muclibc */
  OPT_munaligned_access = 1239,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1240,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1241,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1242,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1243,              /* -mword-relocations */
  OPT_n = 1244,                              /* -n */
  OPT_no_canonical_prefixes = 1245,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1246,              /* -no-integrated-cpp */
  OPT_no_pie = 1247,                         /* -no-pie */
  OPT_nocpp = 1248,                          /* -nocpp */
  OPT_nodefaultlibs = 1249,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1250,                   /* -nostartfiles */
  OPT_nostdinc = 1251,                       /* -nostdinc */
  OPT_nostdinc__ = 1252,                     /* -nostdinc++ */
  OPT_nostdlib = 1253,                       /* -nostdlib */
  OPT_o = 1254,                              /* -o */
  OPT_p = 1255,                              /* -p */
  OPT_pass_exit_codes = 1256,                /* -pass-exit-codes */
  /* OPT_pedantic = 1257, */                 /* -pedantic */
  OPT_pedantic_errors = 1258,                /* -pedantic-errors */
  OPT_pg = 1259,                             /* -pg */
  OPT_pie = 1260,                            /* -pie */
  OPT_pipe = 1261,                           /* -pipe */
  OPT_posix = 1262,                          /* -posix */
  OPT_print_file_name_ = 1263,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1264,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1265,          /* -print-multi-directory */
  OPT_print_multi_lib = 1266,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1267,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1268,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1269,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1270,               /* -print-prog-name= */
  OPT_print_search_dirs = 1271,              /* -print-search-dirs */
  OPT_print_sysroot = 1272,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1273,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1274,                        /* -profile */
  OPT_pthread = 1275,                        /* -pthread */
  OPT_quiet = 1276,                          /* -quiet */
  OPT_r = 1277,                              /* -r */
  OPT_rdynamic = 1278,                       /* -rdynamic */
  OPT_remap = 1279,                          /* -remap */
  OPT_s = 1280,                              /* -s */
  OPT_save_temps = 1281,                     /* -save-temps */
  OPT_save_temps_ = 1282,                    /* -save-temps= */
  OPT_shared = 1283,                         /* -shared */
  OPT_shared_libgcc = 1284,                  /* -shared-libgcc */
  /* OPT_specs = 1285, */                    /* -specs */
  OPT_specs_ = 1286,                         /* -specs= */
  OPT_static = 1287,                         /* -static */
  OPT_static_libasan = 1288,                 /* -static-libasan */
  OPT_static_libgcc = 1289,                  /* -static-libgcc */
  OPT_static_libgfortran = 1290,             /* -static-libgfortran */
  OPT_static_libgo = 1291,                   /* -static-libgo */
  OPT_static_liblsan = 1292,                 /* -static-liblsan */
  OPT_static_libmpx = 1293,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1294,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1295,               /* -static-libstdc++ */
  OPT_static_libtsan = 1296,                 /* -static-libtsan */
  OPT_static_libubsan = 1297,                /* -static-libubsan */
  OPT_static_pie = 1298,                     /* -static-pie */
  /* OPT_std_c__03 = 1299, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1300, */                /* -std=c++0x */
  OPT_std_c__11 = 1301,                      /* -std=c++11 */
  OPT_std_c__14 = 1302,                      /* -std=c++14 */
  OPT_std_c__17 = 1303,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1304, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1305, */                /* -std=c++1z */
  OPT_std_c__2a = 1306,                      /* -std=c++2a */
  OPT_std_c__98 = 1307,                      /* -std=c++98 */
  OPT_std_c11 = 1308,                        /* -std=c11 */
  OPT_std_c17 = 1309,                        /* -std=c17 */
  /* OPT_std_c18 = 1310, */                  /* -std=c18 */
  /* OPT_std_c1x = 1311, */                  /* -std=c1x */
  /* OPT_std_c89 = 1312, */                  /* -std=c89 */
  OPT_std_c90 = 1313,                        /* -std=c90 */
  OPT_std_c99 = 1314,                        /* -std=c99 */
  /* OPT_std_c9x = 1315, */                  /* -std=c9x */
  OPT_std_f2003 = 1316,                      /* -std=f2003 */
  OPT_std_f2008 = 1317,                      /* -std=f2008 */
  OPT_std_f2008ts = 1318,                    /* -std=f2008ts */
  OPT_std_f2018 = 1319,                      /* -std=f2018 */
  ...
  OPT_std_gnu__2a = 1329,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1330,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1331,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1332,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1333, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1334, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1335, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1336,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1337,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1338, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1339, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1340,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1341, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1342, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1343, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1344, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1345, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1346,                     /* -std=legacy */
  OPT_symbolic = 1347,                       /* -symbolic */
  OPT_t = 1348,                              /* -t */
  OPT_time = 1349,                           /* -time */
  OPT_time_ = 1350,                          /* -time= */
  OPT_tno_android_cc = 1351,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1352,                 /* -tno-android-ld */
